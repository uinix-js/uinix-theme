 ...
 *
 * @typedef {{
 *   [key in import('./theme-mapping.js').ThemeProperty]: ThemePropertyDefinition
 * }} Theme
 */
 ...
 *
 * The theme is a mapping of `ThemeProperty` to `ThemePropertyDefinition` (arbitarily nested), which eventually resolves to a valid `ThemePropertyValue`.
 *
